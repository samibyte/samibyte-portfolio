...
/**
 * Contact.tsx — Contact / Let's Connect page
 * 
 * Features:
 * - Glassmorphism contact form with focus glows
 * - Interactive social links panel
 * - Pulsing "Available for work" status badge
 * - GSAP-ready entrance animations
 */
